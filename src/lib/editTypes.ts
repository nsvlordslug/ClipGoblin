...
export const CAPTION_STYLES: CaptionStyle[] = [
  ...
  },
  {
    ...
    fontFamily: "'Russo One', 'Arial Black', Arial, sans-serif",
    fontSize: 60, fontWeight: 400,
    fontColor: '#B8FF2C',
    ...
    shadow: '-1px -1px 0 #E9FF86, 1px 1px 0 #F4D72B, 2px 2px 0 #F4D72B, 3px 3px 0 #7C2FE4, 4px 4px 0 #7C2FE4, 5px 5px 0 #7C2FE4, 6px 6px 0 #7C2FE4, 7px 7px 0 #7C2FE4, 8px 8px 0 #26103D, 9px 9px 0 #26103D, 10px 10px 0 #26103D, 11px 11px 0 #26103D, 12px 12px 0 #12071D, 0 15px 16px rgba(0,0,0,0.78)',
    characterWidthFactor: 0.72,
    safeWidthRatio: 0.78,
  },
  {
    ...
    fontFamily: "'Titan One', 'Arial Black', Arial, sans-serif",
    fontSize: 60, fontWeight: 400,
    fontColor: '#F3F0E8',
    ...
    shadow: '-1px -1px 0 #FFFFFF, 1px 1px 0 #D8D2CA, 2px 2px 0 #B9B4C0, 3px 3px 0 #5C5660, 4px 4px 0 #413B46, 5px 5px 0 #413B46, 6px 6px 0 #6E3794, 7px 7px 0 #6E3794, 8px 8px 0 #5E2A84, 9px 9px 0 #5E2A84, 10px 10px 0 #3E1C57, 11px 11px 0 #3E1C57, 12px 12px 0 #24122F, 0 15px 17px rgba(0,0,0,0.8)',
  ...
  },
  {
    ...
    shadow: '-1px -1px 0 #F4FF75, 1px 1px 0 #7DFF32, 2px 2px 0 #18111F, 3px 3px 0 #8B3DFF, 4px 4px 0 #8B3DFF, 5px 5px 0 #7B32DF, 6px 6px 0 #6B2BC1, 7px 7px 0 #5C249B, 8px 8px 0 #5C249B, 9px 9px 0 #421A70, 10px 10px 0 #421A70, 11px 11px 0 #251137, 12px 12px 0 #170A24, 0 0 6px rgba(119,255,45,0.45), 0 16px 18px rgba(0,0,0,0.82)',
