          ...
          <div className="space-y-2">
            ...
            {deepDiveOpen === 'editor' && (
              <HelpSection key="editor" icon="🎨" title="Editor, captions, and branding" defaultOpen>
                <p><span className="text-white font-medium">Edit tab</span> — Adjust trim, aspect ratio, export preset, and layout. Full Frame center-crops, with a Zoom out slider that can reveal up to 30% more of the source over a subtle video fill. Context Fit keeps the entire scene visible and lets you choose a soft video blur, clean black bars, or branding behind it; Video placement moves that fitted frame up or down. Split and PiP keep gameplay and a second panel visible together.</p>
