          ...
          <div className="space-y-2">
            ...
            {deepDiveOpen === 'publishing' && (
              <HelpSection key="publishing" icon="📤" title="YouTube and TikTok publishing" defaultOpen>
                ...
                <p>Connect under Settings → Accounts and choose one of the privacy options TikTok returns for your account/app. While Direct Post review is pending, TikTok may allow only Only me (private). Accepted means the upload was received and is still processing; private uploads have no public link and can take several minutes to appear under Profile → Private (lock tab) in the mobile app.</p>
